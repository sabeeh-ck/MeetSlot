            ...
            <div className="m-4 flex flex-1 flex-col gap-3 md:gap-4">
                ...
                {loading ? (
                    ...
                    data?.map((data, index) => (
                        <div
                            key={data._id}
                            className={`border-border lg:bg-bg bg-surface flex w-full items-start justify-between rounded-lg border p-4 md:grid md:border-0 md:px-0 md:py-2 ${isRooms ? "h-37.5 md:h-10 md:grid-cols-[0.25fr_1.5fr_1.5fr_0.75fr_1fr_1fr_0.5fr]" : "h-29.5 md:h-10 md:grid-cols-[0.25fr_1.5fr_1.5fr_1fr_0.5fr]"}`}
                        >
                            <div
