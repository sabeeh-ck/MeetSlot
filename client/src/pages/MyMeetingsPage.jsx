            ...
            <div className="lg:border-border bg-bg fixed flex h-32 w-full flex-col gap-5 pb-4 lg:h-full lg:w-64 lg:border-r lg:p-0">
                ...
                <div className="border-border bg-surface lg:bg-bg mx-4 flex gap-1 rounded-xl border p-1 lg:flex-col lg:gap-2 lg:border-0 lg:p-0">
                    ...
                    <button
                        ...
                        className={`flex flex-1 scale-100! items-center justify-center gap-1 rounded-lg py-2 text-sm font-medium transition-all lg:justify-between lg:px-2 ${view === "past" ? "bg-text text-bg lg:text-text lg:bg-border shadow lg:shadow-none" : "lg:text-text active:bg-border text-textmute lg:hover:bg-border"}`}
                    >
                        <span>Past</span>
